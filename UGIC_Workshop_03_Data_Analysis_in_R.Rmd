...
Now let's repeat these steps with a random forest. There are several packages for this, but we'll use the **RandomForest** package, which is the oldest and most stable. 
