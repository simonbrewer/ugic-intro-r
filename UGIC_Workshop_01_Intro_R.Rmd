---
title: "GEOG 5160/6160: 01 Introduction to R Lab"
...
And paste your directory between the quotes. The code should look something like this:
...
Start by changing your working directory to the directory holding the two file listed above. Then get a list of files as follows (note the use of the pattern parameter to get only certain files):
