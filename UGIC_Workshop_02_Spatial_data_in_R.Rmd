...
The way that `sf` chooses to represent simple features in R should be familiar to you because they are just fancy data.frames. To demonstrate this, we'll load a file of county outlines for North Carolina (this file is included when you install the `sf` package):
